...
/*
const CarConstructor = function (make, speed) {
  this.make = make;
  this.speed = speed;
};
CarConstructor.prototype.accelerate = function () {
  this.speed += 10;
  console.log('accelrate speed: ' + this.speed);
};
CarConstructor.prototype.brake = function () {
  this.speed -= 5;
  console.log('BRAKE speed: ' + this.speed);
};
...
// rivian.accelerate().brake().accelerate().chargeBattery(90);
// console.log(rivian);
